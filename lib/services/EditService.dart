...
class EditDialogService extends StatefulWidget {
  const EditDialogService(
      {required this.title,
  ...
  EditDialogServiceState createState() => EditDialogServiceState();
}

class EditDialogServiceState extends State<EditDialogService> {
    ...
    return AlertDialog(
      ...
      actions: <Widget>[
        FlatButton(
          ...
          onPressed: () {
            if (_validateDialog) {
              widget.submit(textFieldController.text.toString(),context,_image);
