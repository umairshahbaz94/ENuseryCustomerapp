...
import 'package:shop_app/screens/cart/Widget/cartlist.dart';
...
final Map<String, WidgetBuilder> routes = {
  ...
  // // AddProdcut.routeName:(context)=>AddProdcut(),
  // AddService.routeName: (context) => AddService(),
  CustomerScreen.routeName: (context) => CustomerScreen(),
  CrtList.routeName: (context) => CrtList(),
};
